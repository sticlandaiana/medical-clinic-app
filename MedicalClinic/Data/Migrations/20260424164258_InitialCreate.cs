    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConsultationTypes", x => x.ConsultationTypeId);
                    table.ForeignKey(
                        name: "FK_ConsultationTypes_Specialities_SpecialityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExternalDocuments", x => x.ExternalDocumentId);
                    table.ForeignKey(
                        name: "FK_ExternalDocuments_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "PatientId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsultationTypes_SpecialityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExternalDocuments_PatientId",
